...
//$last_to_die = $_POST["answer26"];

$other_trustee_partner = $_POST["answer12-2"];
 ...
 $divorce = $_POST["answer24"];

 $spouse = $_POST["answer25"];

 $divorce_trustee = $_POST["answer26"];
 ...
 $body = '<span style="color:dimgray">Name:</span> ' . $name . '<br /><br />' .
 		...
 		'<span style="color:dimgray">Do you agree to serve as Co-trustees during your lifetime?</span> ' . $trustee . '<br /><br />' .
 		'<span style="color:dimgray">If no, please name the partner who will serve as sole Trustee:</span> ' . $other_trustee . '<br /><br />' .
		'<span style="color:dimgray">If you would rather name a Trustee other than yourselves to serve while you are living, please state the name, address, and phone number of named Trustee.</span>' . $other_trustee_partner . '<br /><br />' .
 		'<span style="color:dimgray">Upon the death of one Trustee, the surviving Trustee may continue to serve as Trustee. Please list the name, address, and phone number of your chosen Successor Trustee.</span> ' . $upon_death . '<br /><br />'  .
 		'<span style="color:dimgray">Option:</span> ' . $option  . '<br /><br />' . $option_content . '<br /><br />' . '<span style="color:dimgray">If either spouse should initiate a divorce proceeding in court, please specify the name, address, and phone number of the person(s) who shall serve as Trustee upon the finalization of the divorce: </span> ' .  $divorce_trustee . '<br/></br>' . 'We agree that the final divorce decree shall reflect the following: ' . $divorce . '<br/><br />' . '<span style="color:dimgray">All embryos shall become the property of [Spouse] at the time the divorce is finalized, and such ownership shall be reflected in the final divorce decree:</span>' . $spouse .
 		'<br/><br />' . '<span style="color:dimgray">Additional requests:</span> ' . $additional;
